          ...
          <table class="table-fixed">
              ...
              <tbody>
                ...
                @foreach ($breakfasts as $breakfast)
                    ...
                    <td class="px-4 py-2">
                        <div class="flex">
                        <!-- <a href="/view/hotel/{{$hotel->hotel_id}}/breakfast/{{$breakfast->btype}}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">View</a> -->
                        <a href="/edit/hotel/{{$hotel->hotel_id}}/breakfast/{{$breakfast->btype}}" class="ml-2 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">Edit</a>

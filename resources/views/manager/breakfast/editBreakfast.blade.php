...
@section('content')
    <div class="flex justify-center align-items-center">
        <div class="text-4xl font-black pr-12 py-6">Edit Breakfast</div>
    </div>
    <div class="flex justify-center content-center">
      <form class="w-full max-w-md m-auto" method="POST" action="{{ route('edit_breakfast',['hotel_id' => $hotel_id,'btype' => $breakfast->btype]) }}">
      @csrf
        ...
        <div class="md:flex md:items-center mb-6 opacity-50">
          ...
          <div class="md:w-2/3">
            <input disabled id="btype" type="text" name="btype" value="{{ $breakfast->btype }}" required autocomplete="btype" autofocus
            class="@error('btype') border-red-400 @enderror disabled bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500"
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="bprice" type="text" name="bprice" value="{{ $breakfast->bprice }}" required autocomplete="bprice" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            class="@error('description') border-red-400 @enderror bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500"
             placeholder="Description">{{ $breakfast->description }}</textarea>
            @error('description')
            <div><p class="text-red-400 text-xs italic">{{ $message }}</p></div>  
            @enderror
          </div>

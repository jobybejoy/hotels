    ...
    <div class="flex justify-center align-items-center">
        ...
        <table class="table-fixed">
            ...
            @foreach ($hotels as $hotel)
                ...
                <td class="px-4 py-2">
                    <div class="flex">
                    <a href="/view/hotel/{{$hotel->hotel_id}}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">View</a>

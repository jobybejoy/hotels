...
@section('content')
    <div class="flex justify-center align-items-center">
        <div class="text-4xl font-black pr-12 py-6">Edit Hotel</div>
    </div>
    <div class="flex justify-center content-center">
      <form class="w-full max-w-sm m-auto" method="POST" action="{{ route('edit_hotel',['hotel_id' => $hotel->hotel_id]) }}">
      @csrf
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            placeholder="33rd Street">{{ $hotel->street }}</textarea>
            @error('street')
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="state" type="text" name="state" value="{{ $hotel->state }}" required autocomplete="state" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="country" type="text" name="country" value="{{ $hotel->country }}" required autocomplete="country" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="zip" type="text" name="zip" value="{{ $hotel->zip }}" required autocomplete="zip" autofocus

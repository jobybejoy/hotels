...
@section('content')
    <div class="flex justify-center align-items-center">
        <div class="text-4xl font-black pr-12 py-6">Edit Service</div>
    </div>
    <div class="flex justify-center content-center">
      <form class="w-full max-w-md m-auto" method="POST" action="{{ route('edit_service',['hotel_id' => $hotel_id,'stype' => $service->stype]) }}">
      @csrf
        ...
        <div class="md:flex md:items-center mb-6 opacity-50">
          ...
          <div class="md:w-2/3">
            <input disabled id="stype" type="text" name="stype" value="{{ $service->stype }}" required autocomplete="stype" autofocus
            class="@error('stype') border-red-400 @enderror disabled bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500"
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="sprice" type="text" name="sprice" value="{{ $service->sprice }}" required autocomplete="sprice" autofocus

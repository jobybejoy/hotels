...
@section('content')
    ...
    <div class="w-3/4">
      <div class="flex justify-center align-items-center">
          ...
          <a href="/add/hotel/{{$hotel->hotel_id}}/service" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">Add</a>
      </div>
      <div class="flex justify-center align-items-center">
          <div class="flex p-2">
          @if(!empty($services))
          <table class="table-fixed">
              ...
              <tbody>
                ...
                @foreach ($services as $service)
                    ...
                    <td class="px-4 py-2">
                        <div class="flex">
                        <a href="/edit/hotel/{{$hotel->hotel_id}}/service/{{$service->stype}}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">Edit</a>
                        <a href="/delete/hotel/{{$hotel->hotel_id}}/service/{{$service->stype}}" class="ml-2 bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded">Delete</a>
                        </div>
                    </td>
                    <td class="py-2">
                        <div class="flex">
                        <a href="/review/hotel/{{$hotel->hotel_id}}/service/{{$service->stype}}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">Review</a>
                        <a href="/reservation/hotel/{{$hotel->hotel_id}}/service/{{$service->stype}}" class="ml-2 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded">Reservation</a>
                        </div>
                    </td>
                    </tr>
                @endforeach

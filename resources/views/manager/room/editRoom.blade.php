...
@section('content')
    <div class="flex justify-center align-items-center">
        <div class="text-4xl font-black pr-12 py-6">Edit Room</div>
    </div>
    <div class="flex justify-center content-center">
      <form class="w-full max-w-md m-auto" method="POST" action="{{ route('edit_room',['hotel_id' => $hotel_id,'room_no'=>$room->room_no]) }}">
      @csrf

        <div class="md:flex md:items-center mb-6 opacity-50">
          <div class="md:w-1/3">
          ...
          <div class="md:w-2/3">
            <input disabled id="room_no" type="text" name="room_no" value="{{ $room->room_no }}" required autocomplete="room_no" autofocus
            class="@error('room_no') border-red-400 @enderror disabled bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500" 
            placeholder="102">
            @error('room_no')
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="r_type" type="text" name="r_type" value="{{ $room->r_type }}" required autocomplete="r_type" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="price" type="text" name="price" value="{{ $room->price }}" required autocomplete="price" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="floor" type="text" name="floor" value="{{ $room->floor }}" required autocomplete="floor" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input  id="capacity" type="text" name="capacity" value="{{ $room->capacity }}" required autocomplete="capacity" autofocus
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            placeholder="33rd description">{{ $room->description }}</textarea>
            @error('description')
            <div><p class="text-red-400 text-xs italic">{{ $message }}</p></div>  
            @enderror
          </div>
